...
## 2026-01-23 - [Market Hours Vectorization] **Learning:** Per-tick timezone conversion and holiday checks are extremely expensive (55x slowdown). **Action:** Precompute market open/close masks vectorized on the DatetimeIndex.
