...
```
https://kite.trade/connect/login?api_key=<YOUR_KITE_API_KEY>&v=3
```

**Or use this direct link:**
- Replace `<YOUR_KITE_API_KEY>` with your API key if different
...
### "Invalid API key"
- Verify your API key is correct: `<YOUR_KITE_API_KEY>`
