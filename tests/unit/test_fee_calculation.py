...
def test_futures_fee_calculation(risk_manager):
    ...
    Expected Breakdown (Feb 2025 rates):
        ...
        STT (0.02% on Sell): (50 * 20100) * 0.0002 = 201.0
        Stamp Duty (0.003% on Buy): (50 * 20000) * 0.00003 = 30.0
        SEBI: 2005000 * 10/1Cr = 2.005

    Total Expected: 40 + 38.095 + 14.057 + 201.0 + 30.0 + 2.005 = 325.157
    """
    instrument = Instrument(
        token=124,
        symbol="NIFTY",
